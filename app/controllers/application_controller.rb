class ApplicationController < ActionController::Base
  ...
  # Error msg for handling when user is not authorised by
  # CanCan to perform the action attempted (redirects and
  # displays msg):
  ...
  # Setting search query object as @q before every action.
  # Set in this model as search is performed in sidebar
  # which is accessed in multiple views
  def set_query
  ...
  # Allowing users to complete any of the below fields
  ...
  def configure_permitted_parameters
    ...
    # Allowing users to update any of the below fields
    # once an existing member
